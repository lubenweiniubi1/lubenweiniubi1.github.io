// ============================================================
// build.js — 静态站点生成器
// 把 notes/ 目录扫描并生成纯静态文件到 dist/，供 GitHub Pages 使用
// 运行方式：node notes/build.js
// ============================================================
const fs = require("fs");
...
// ============================================================
// 3. 生成 HTML（从 startup.js 复制模板，去掉 Express 相关部分）
// ============================================================
...
// ============================================================
// 4. 复制 .md 文件到 dist/，保持目录结构
// ============================================================
function copyMdFiles(srcDir, distDir) {
